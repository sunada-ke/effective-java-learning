...
public final class Main {
	...
	public static void main(String[] args) {
		...
		new PersonForConstructor("Legend", "man", 25);
		...
		PersonForBuilder personForBuilder = new PersonForBuilder.Builder("Legend", "man").age(25).birthplace("Tokyo")
				.build();
